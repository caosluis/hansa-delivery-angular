...
export class TarjetaVisitaComponent implements OnInit {
  ...
  async CargarDatosOt() {
    await this.CoordenadasService.CargarDatosVisita(this.ot_seleccionada).then(
      (data) => {
  ...
  CargarTareasPorVisitas() {
    this.CoordenadasService.CargarTareasPorVisitas(this.VisitaID).then(
      (tarea) => {
  ...
  CargarFotosPorVisitas() {
    this.CoordenadasService.CargarFotosPorVisitas(this.VisitaID).then(
      (foto) => {
